if(typeof contentScriptLoaded == "undefined") {
  ...
  console.log("TweetStorm> Initializing");
  ...
  splitTweet = function() {
    ...
    while(words.length > 0) {
      ...
      console.log("TweetStorm> Tweet #"+tweetNumber+" is "+tweetLength+" chars long: "+ tweet, tweet.length);
      if(words.length>0)
        console.log("TweetStorm> Next word: "+words[0], words[0].length);
